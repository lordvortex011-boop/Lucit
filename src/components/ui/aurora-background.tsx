...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        "transition-bg relative flex min-h-[100dvh] w-full flex-col items-center justify-center bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50",
        className
      )}
